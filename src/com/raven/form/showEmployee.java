...
public class showEmployee extends javax.swing.JPanel {
    ...
    public showEmployee() throws Exception {
         initComponents();
    ...
    public void show_emp() throws Exception{
     ...
     ResultSetMetaData rsmd=rs.getMetaData();
      ...
      DefaultTableModel model=(DefaultTableModel) table.getModel();
        ...
        String empName,phoneNo,emialid,dob,addr,pass;
        while(rs.next()){
            empName=rs.getString("name");
            phoneNo=rs.getString("phone");
            emialid=rs.getString("email");
            dob=rs.getString("dob");
            addr=rs.getString("address");
            pass=rs.getString("password");
            String []row={empName,phoneNo,emialid,dob,addr,pass};
            model.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name","Contact","Email","Date of Birth","Address","Password"
            }
        ) {
